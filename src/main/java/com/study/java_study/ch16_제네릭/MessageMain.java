...
//        String s = m1.getMessage();   // Object 자료를 String으로(다운캐스팅)하려니 안됨
        ...
        Message<? extends String> m3 = new Message<>("10"); // 하행 (나자신 포함 아래 클래스들 전부 사용 가능)
        Message<? super String> m4 = new Message<>("new Objevt()"); // 상행 ( 나자신 포함 상위 클래스들은 다 가능)

        String s2 = m3.getMessage(); // 다운 캐스팅 필요없음(다운 캐스팅) : 밑에도 다 포함되기 때문
